<template>
  <div class="container">
    ...
    <div class="box">
      ...
      <div class="pageBox">
        <pagination v-show="total1>0" :total="total1" :page.sync="page1.pageIndex" 
            :limit.sync="page1.pageSize" @pagination="getList1" />
      </div>
    </div>
  </div>
</template>
...
export default {
  ...
  methods: {
    ...
    order1(row) {
      return this.page1.pageSize * (this.page1.pageIndex - 1) + row.rowIndex + 1;
    },
  }
};
</script>
