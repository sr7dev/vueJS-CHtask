  ...
  <el-row class="tac">
    <el-col :span="24">
      ...
      >
        ...
        <el-menu-item index="/jobDefinition" v-if="menuShowArr['jobDefinition'] && creditMode<0">
        ...
        <el-menu-item index="/trainingFunds" v-if="menuShowArr['trainingFunds'] && creditMode<0">
        ...
        <el-menu-item index="/userManagement" v-if="menuShowArr['userManagement'] && creditMode<0">
        ...
        <el-menu-item index="/greenProducts" v-if="menuShowArr['greenProducts'] && creditMode<0">
