<template>
  <div class="container">
    ...
    <div class="box">
      <div class="iptBox">
        <el-button style="margin-right: 25px" @click="add()" plain type="primary">添加</el-button>
      ...
      <el-container>
        <el-table :data="tableData" style="width: 100%" :row-class-name="rowIndex">
          ...
          <el-table-column prop="classification" label="选项排序"></el-table-column>
    ...
    <el-dialog :title="dialogTitle" :visible.sync="dialogFormVisible">
      ...
      <div slot="footer" class="dialog-footer">
        <el-button @click="dialogFormVisible = false" plain type="danger">取 消</el-button>
        <el-button type="success" @click="dialogFormVisible = false" plain>确 定</el-button>
      </div>
    </el-dialog>
  </div>
</template>
